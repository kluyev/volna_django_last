    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('parent', 'Родитель'), ('staff', 'Сотрудник'), ('admin', 'Администратор')], default='parent', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_approved', models.BooleanField(default=False, verbose_name='Подтверждённый доступ')),
